...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='tt_auth_group',
            fields=[
                ('tt_until_from_ts', models.DecimalField(default=999999999999, auto_created=True, max_digits=18, decimal_places=6)),
                ...
                ('tt_create_modif_user_id', models.BigIntegerField(null=True, auto_created=True, db_index=True)),
                ('tt_delete_user_id', models.BigIntegerField(null=True, auto_created=True, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tt_valid_from_ts', models.DecimalField(default=0, auto_created=True, max_digits=18, decimal_places=6)),
                ('tt_id', models.AutoField(verbose_name=b'TT_ID', serialize=False, auto_created=True, primary_key=True)),
                ('session_key', models.CharField(max_length=40, verbose_name='session key', db_index=True)),
